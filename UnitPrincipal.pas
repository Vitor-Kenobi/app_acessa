...
type
  TFrmPrincipal = class(TForm)
    ...
    Label1: TLabel;
    Layout2: TLayout;
    lbl_materia_melhor_des: TLabel;
    lbl_melhor_des: TLabel;
    Layout3: TLayout;
    Layout4: TLayout;
    Layout5: TLayout;
    Image2: TImage;
